			...
			if (!isRetry) {
	            ...
	            switch (imgTopic) {
	                case "prdImgError" :
	                    ...
	                    var paddingRight = (parseInt(dpThis.css("padding-right")) + 10) + "px";
	                    var paddingLeft  = (parseInt(dpThis.css("padding-left"))  + 10) + "px";
	                    var paddingTop   = (parseInt(dpThis.css("padding-top"))   + 10) + "px";
	                    var paddingBottom= (parseInt(dpThis.css("padding-bottom"))+ 10) + "px";
	                    var width        = (parseInt(dpThis.width())  - 20) + "px";
	                    var height       = (parseInt(dpThis.height()) - 20) + "px";
